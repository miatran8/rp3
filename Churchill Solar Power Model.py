...
# PV model (Si versus Tandem) with NOCT (Nominal Operating Cell Temperature) temperature
T_air = ts["T_air_C"].to_numpy()
NOCT = 45.0

T_cell = T_air + (POA/800.0)*(NOCT - 20.0) # Equation from Sun et al. (2021)
ts["T_cell_C"] = T_cell
eta_inv = 0.97
...
# efficiency of silicon PV cells is 0.21 (source: https://www.energy.gov/eere/solar/crystalline-silicon-photovoltaics-research)
P_tn, eta_tn = pv_power(POA, T_cell, eta_stc=0.34, gamma=-0.0025)
# efficiency of perovskite/silicon tandem PV cells is 0.34 (source: https://www.energy.gov/eere/solar/perovskite-solar-cells)
